          ...
          <div class="card-body p-0 mt-10">
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <div class="p-5">
                  <a href="index.php" class="btn mb-4 mr-5">
                  ...
                  <form class="user" method="post" action="simpan_masyarakat.php">
                    ...
                    <div class="form-group">
                      <input type="text" name="nama" class="form-control form-control-user" id="exampleInputPassword" placeholder="Nama Lengkap">
                    </div>
                    ...
                    <input type="submit" class="btn btn-light btn-user btn-block" value="Registrasi">
