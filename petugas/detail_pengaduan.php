        ...
        <div class="card-body">
            ...
            <div class="card-body">
                <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <a href="proses.php?id=<?php echo $data['id_pengaduan'];?>" class="btn btn-success btn-icon-split" onclick="return confirm('Yakin Akan Di Proses ?')">
                    <span class="icon text-white-50">
                ...
                <a href="tolak.php?id=<?php echo $data['id_pengaduan'];?>" class="btn btn-danger btn-icon-split" onclick="return confirm('Tolak Laporan ?')">
                    <span class="icon text-white-50">
